                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Tour This Home <small>Register to tour this home with a local real estate agent.</h3>
                        </div>
                        <div class="panel-body">
                            <form role="form">
                                ...
                                <div class="form-group">
                                    <input type="password" name="password" id="password_confirmation" class="form-control" placeholder="Password" tabindex="6">
                                </div>
                                <div class="form-group">
